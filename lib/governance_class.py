...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to bitglod "gobject list" output
    ...
    def bitglod_serialise(self):
        import bitglolib
        return bitglolib.SHIM_serialise_for_bitglod(self.serialise())

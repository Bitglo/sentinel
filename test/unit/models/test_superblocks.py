...
def go_list_proposals():
    items = [
        {u'AbsoluteYesCount': 1000,
         ...
         u'DataString': u'[["proposal", {"end_epoch": 2122520400, "name": "dean-miller-5493", "payment_address": "nLLGSuauCV21NBpHJpLHKevWpwE3t6CHGc", "payment_amount": 25.75, "start_epoch": 1474261086, "type": 1, "url": "http://bitglocentral.org/dean-miller-5493"}]]',
        ...
        {u'AbsoluteYesCount': 1000,
         ...
         u'DataString': u'[["proposal", {"end_epoch": 1528131515, "name": "fernandez-7625", "payment_address": "nLLGSuauCV21NBpHJpLHKevWpwE3t6CHGc", "payment_amount": 25.75, "start_epoch": 1528127950, "type": 1, "url": "http://bitglocentral.org/fernandez-7625"}]]',
...
def test_deterministic_superblock_creation(go_list_proposals):
    ...
    sb = bitglolib.create_superblock(prop_list, 72000, budget_max=max_budget, sb_epoch_time=misc.now())

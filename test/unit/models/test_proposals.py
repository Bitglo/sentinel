...
def go_list_proposals():
    items = [
        {u'AbsoluteYesCount': 1000,
         ...
         u'DataString': u'[["proposal", {"end_epoch": 2122520400, "name": "dean-miller-5493", "payment_address": "BJjGZTPnsbgoU5uLVhPnR3HCt5v4qrf4Zo", "payment_amount": 25.75, "start_epoch": 1474261086, "type": 1, "url": "http://bitglocentral.org/dean-miller-5493"}]]',
        ...
        {u'AbsoluteYesCount': 1000,
         ...
         u'DataString': u'[["proposal", {"end_epoch": 1528131515, "name": "fernandez-7625", "payment_address": "BJjGZTPnsbgoU5uLVhPnR3HCt5v4qrf4Zo", "payment_amount": 25.75, "start_epoch": 1528127950, "type": 1, "url": "http://bitglocentral.org/fernandez-7625"}]]',
...
def proposal():
    ...
    pobj = Proposal(
        ...
        url="https://vote.bitglo.io/update_trade_charts",
        payment_address="BJjGZTPnsbgoU5uLVhPnR3HCt5v4qrf4Zo",
        payment_amount=13
    )
...
def test_proposal_is_valid(proposal):
    ...
    # this is actually the Bitglo foundation multisig address...
    proposal.payment_address = '7gnwGHt17heGpG9Crfeh4KGpYNFugPhJdh'
    assert proposal.is_valid() is False

    proposal.payment_address = 'BJjGZTPnsbgoU5uLVhPnR3HCt5v4qrf4Zo'
    assert proposal.is_valid() is True
    ...
    # ============================================================
    # ensure proposal can't request negative bitglo
    # ============================================================
...
def test_approved_and_ranked(go_list_proposals):
    ...
    for item in go_list_proposals:
        (go, subobj) = GovernanceObject.import_gobject_from_bitglod(bitglod, item)
